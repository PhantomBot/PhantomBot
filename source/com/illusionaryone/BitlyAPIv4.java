...
/*
 * Communicates with the Bitly API v4
 *
...
public class BitlyAPIv4 {
    ...
    private static JSONObject readJsonFromUrl(String urlAddress, String longURL) throws JSONException {
        ...
        try {
            jsonRequest = "{ \"group_guid\": \"" + sGUID + "\", \"long_url\": \"" + longURL + "\"}";
            ...
            urlConn.addRequestProperty("Authorization", "Bearer " + sAPIKey);
            ...
            com.gmt2001.Console.err.println("BitlyAPIv4::readJsonFromUrl::Exception: " + ex.getMessage());
    ...
    /*
     * Sets a different GUID than the default.
     *
     * @param  String  Bitly GUID
     */
