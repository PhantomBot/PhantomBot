...
2. Set the project Java SDK to [1.11](http://www.oracle.com/technetwork/java/javase/overview/index.html).
...
3. Open up a file from `./source/` where IntelliJ will ask you for a project SDK. Use SDK [1.11](http://www.oracle.com/technetwork/java/javase/overview/index.html).
