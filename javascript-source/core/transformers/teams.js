...
(function () {
    ...
    var transformers = [
        new $.transformers.transformer('team_member_followers', ['twitch', 'command', 'teams'], team_member_followers),
        new $.transformers.transformer('team_member_game', ['twitch', 'command', 'teams'], team_member_game),
        new $.transformers.transformer('team_member_url', ['twitch', 'command', 'teams'], team_member_url),
        new $.transformers.transformer('team_members', ['twitch', 'command', 'teams'], team_members),
        new $.transformers.transformer('team_name', ['twitch', 'command', 'teams'], team_name),
        new $.transformers.transformer('team_random_member', ['twitch', 'command', 'teams'], team_random_member),
        new $.transformers.transformer('team_url', ['twitch', 'command', 'teams'], team_url)
    ];
