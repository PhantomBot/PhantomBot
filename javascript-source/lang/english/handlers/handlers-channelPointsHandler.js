...
$.lang.register('channelpointshandler.command.info', 'converts the redeemable into a command, then parses command tags as if a custom command was called as the bot. See "!channelpoints command add" to configure, "!channelpoints command usage" for usage, or "!channelpoints command example" for an example');
...
$.lang.register('channelpointshandler.command.get.usage', 'usage: !channelpoints command get (redeemable id)');
$.lang.register('channelpointshandler.command.get.404', 'there is no command for channel points redeemable id $1');
$.lang.register('channelpointshandler.command.add.usage1', 'usage: !channelpoints command add (custom command definition)');
...
$.lang.register('channelpointshandler.command.add.usage3', '(1) will be the redeeming user\'s login name, (2) the redeeming user\'s display name, (3) the redeemable input box text (if used)');
...
$.lang.register('channelpointshandler.command.edit.usage1', 'usage: !channelpoints command edit (redeemable id) (custom command definition)');
$.lang.register('channelpointshandler.command.edit', 'redeemable $1 is now registered to: $2');
$.lang.register('channelpointshandler.command.remove.usage', 'usage: !channelpoints command remove (redeemable id)');
