...
$.lang.register('customcommands.shortcut.usage', 'usage: !shortcut [add | del | list]');
$.lang.register('customcommands.shortcut.add.usage', 'usage: !shortcut add [shortcut] [command] [parameters]');
$.lang.register('customcommands.shortcut.add.shortcut.exists', 'Cannot create shortcut, it is already a command: $1');
$.lang.register('customcommands.shortcut.add.command.noexists', 'Cannot create shortcut, command does not exist: $1');
$.lang.register('customcommands.shortcut.add.success', 'Added new shortcut: $1 $2 $3');
$.lang.register('customcommands.shortcut.del.usage', 'usage: !shortcut del [shortcut]');
$.lang.register('customcommands.shortcut.del.noexists', 'Cannot delete shortcut, it is not defined: $1');
$.lang.register('customcommands.shortcut.del.success', 'Deleted shortcut: $1');
$.lang.register('customcommands.shortcut.list', 'Shortcuts: $1');
$.lang.register('customcommands.shortcut.list.empty', 'There are no shortcuts');
