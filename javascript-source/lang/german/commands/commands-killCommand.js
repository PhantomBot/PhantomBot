...
$.lang.register('killcommand.self.26', '$1\'s lebenswichtigestes Organ wurde gebrochen.');
...
$.lang.register('killcommand.self.8', '$1 hat versucht, sich mit einem wilden Grizzly anzufreunden.');
...
$.lang.register('killcommand.other.32', '(Gefängnis) $4 wurde von $1 bezahlt, um $2 zu ermorden. $1 Plan scheiterte, weil $4 tatsächlich ein verdeckter Polizist war!');
$.lang.register('killcommand.other.33', '$1 schlug den letzten Schlag und endete $2.');
$.lang.register('killcommand.other.30', '(jail) $1 versuchte, $2 zu ermorden, aber Swat versteckte sich in den Büschen und sprang auf $1, bevor es getan werden konnte.');
$.lang.register('killcommand.other.31', '(jail) $1 wollte $2 mit einem Hammer schlagen. Allerdings war $2 ein verdeckter Ermittler!');
$.lang.register('killcommand.other.36', '$1 wurde von $2 von einer Leiter geschossen.');
$.lang.register('killcommand.other.37', '$1 versuchte, während der Flucht vor $2, durch Lava zu schwimmen.');
$.lang.register('killcommand.other.34', '$1 verendete gerechterweise durch $2.');
$.lang.register('killcommand.other.35', '$1 wurde von $2 in die Luft gejagt.');
$.lang.register('killcommand.other.38', '$1 wurde von $2ermordet.');
$.lang.register('killcommand.other.39', '$1 führte einen tödlichen Schlag bei $2 durch.');
$.lang.register('killcommand.other.29', '(jail) $1 versuchte $2 mit einem Einhorn-horn zu töten, aber die Polizei tauchte auf, bevor $1 Zeit hatte.');
...
$.lang.register('killcommand.self.51', '$1 wurde von einer Schraube der Inspiration getroffen. Warte, macht nichts. Blitz!');
$.lang.register('killcommand.self.50', '$1 ist spontan verbrannt.');
$.lang.register('killcommand.self.53', '$1 passierte den Ereignishorizont.');
...
$.lang.register('killcommand.other.40', '$1 schlug $2 zu Tode.');
$.lang.register('killcommand.other.45', '(Gefängnis) $2 wird durch eine unbekannte Kraft geschützt, die $1 abstößt.');
$.lang.register('killcommand.other.44', '(Gefängnis) $1 griff $2 mit einem Plastiklöffel an, aber plötzlich umgab ein Schwarm der Polizei $1 und verhaftete sie.');
...
$.lang.register('killcommand.self.46', '$1 wurde beim Kacken vom Blitz erschlagen.');
$.lang.register('killcommand.self.47', '$1 versuchte nach 30 RedBull zu fliegen und fiel von einem Hochhaus.');
$.lang.register('killcommand.self.44', '$1 flog in die Luft.');
$.lang.register('killcommand.self.45', '$1 fiel in einen Feuerfleck.');
$.lang.register('killcommand.self.42', '$1 versuchte in Lava zu schwimmen.');
$.lang.register('killcommand.self.43', '$1 erfuhr kinetische Energie.');
$.lang.register('killcommand.self.40', '$1 löste sich in Säure auf.');
$.lang.register('killcommand.self.41', '$1 versuchte in Säure zu schwimmen.');
$.lang.register('killcommand.self.39', '$1 erfror.');
