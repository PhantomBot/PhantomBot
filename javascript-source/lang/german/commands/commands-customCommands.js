...
$.lang.register('customcommands.botcommands.total', 'Insgesamt Seiten: $1 [Siehe auch: https://phantombot.github.io/PhantomBot/guides/#guide=content/commands/commands]');
...
$.lang.register('customcommands.token.usage', 'Verwendung: !tokencom (command) (token) — WARNUNG: Dies sollte über die Bot-Konsole oder Web-Panel erfolgen. Wenn du das im Chat ausführst, kann jeder, der den Chat sieht, Ihre Informationen kopieren!');
$.lang.register('customcommands.reset.usage', 'Verwendung: !resetcom (Befehl) (Zähler). Wenn kein (Zähler), dann auf 0 zurücksetzen.');
