...
$.lang.register('ranks.custom.usage', 'Verwendung: !rankedit custom [Benutzer] [Rangname]');
...
$.lang.register('ranks.customdel.usage', 'Verwendung: !rankedit customdel [Benutzer]');
...
$.lang.register('ranks.add.usage', 'Verwendung: !rankedit add [Stunde] [Rangname]');
...
$.lang.register('ranks.del.usage', 'Verwendung: !rankedit del [Stunde]');
...
$.lang.register('ranks.rank.success', '$1 hat den Rang $2 erreicht und ist $3 Stunden vom nächsten Rang entfernt!');
$.lang.register('ranks.rank.norank.success', '$1 hat bisher noch keinen Rang aber ist $2 Stunden vom nächsten Rang entfernt!');
$.lang.register('ranks.rank.success', '$1 has reached the rank of $2 and is $3 hours away from the next rank!');
$.lang.register('ranks.rank.maxsuccess', '$1 hat den maximalen Rang $2 erreicht!');
$.lang.register('ranks.rank.customsuccess', '$1 has been designated the rank of $2!');
$.lang.register('ranks.set.usage', 'Verwendung: !rank set [Rangname] Benötigt $1 Stunden im Chat und $2 $3.');
$.lang.register('ranks.set.usage.nopoints', 'Verwendung: !rank set [Rangname] Benötigt $1 Stunden im Chat.');
...
$.lang.register('ranks.set.success', 'Setze Rang auf: $1');
