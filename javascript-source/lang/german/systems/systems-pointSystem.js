$.lang.register('pointsystem.add.all.success', '$1 wurden an jeden im Kanal gesendet!');
$.lang.register('pointsystem.add.all.usage', 'Verwendung: "!points all [Wert]"');
$.lang.register('pointsystem.add.error.negative', 'You can not give negative $1.');
$.lang.register('pointsystem.add.success', '$1 an $2 gesendet. Neuer Stand ist $3.');
$.lang.register('pointsystem.add.usage', 'Verwendung: "!points give [Name] [Wert]"');
$.lang.register('pointsystem.get.self.nopoints', 'Du hast zur Zeit keine $1. Bleibe im Chat um $1 zu verdienen!');
$.lang.register('pointsystem.get.self.withtime', 'Du hast zur Zeit $2, und bist im Chat seit $3.');
$.lang.register('pointsystem.user.usage', 'Verwendung: !points user [Benutzername]');
$.lang.register('pointsystem.user.success', ' $1 hat zur Zeit $2.');
...
$.lang.register('pointsystem.makeitrain.usage', 'Verwendung: "!makeitrain [Wert]"');
...
$.lang.register('pointsystem.set.bonus.usage', 'Verwendung: "!points bonus [Wert]"');
...
$.lang.register('pointsystem.set.gain.offline.usage', 'Verwendung: "!points setofflinegain [Wert]", wenn du !grouppoints gesetzt hast, wird dies überschrieben!');
$.lang.register('pointsystem.set.gain.success', 'Set the $1 earnings to $2 every $3 minute(s) while the stream is online.');
$.lang.register('pointsystem.set.gain.usage', 'Verwendung: "!points setgain [Wert]", wenn du !grouppoints gesetzt hast, wird dies überschrieben!');
...
$.lang.register('pointsystem.set.interval.offline.usage', 'Verwendung: "!points setofflineinterval [Wert]"');
$.lang.register('pointsystem.set.interval.success', 'Set the $1 payout interval to $2 minute(s) when the stream is online.');
$.lang.register('pointsystem.set.interval.usage', 'Verwendung: "!points setinterval [Wert]"');
$.lang.register('pointsystem.set.name.both.success', 'Der Name der Punkte wurde jetzt von "$1" in "$2" geändert. Setze den Namen für einen einzelnen $2 mit "!points setname single [Name]".');
...
$.lang.register('pointsystem.set.name.delete', 'Benutzerdefinierte Punktenamen wurden entfernt.');
...
$.lang.register('pointsystem.setbalance.usage', 'Verwendung: "!points set [Name] [Wert]"');
...
$.lang.register('pointsystem.take.usage', 'Verwendung: "!points take [Name] [Wert]"');
$.lang.register('pointsystem.gift.usage', 'Verwendung: !gift [Benutzer] [Wert]');
