...
$.lang.register('ytplayer.announce.nextsong', 'SingsNote Now Playing [$1] Requester: $2');

$.lang.register('ytplayer.console.client.connected', 'SingsNote Song Request Player is connected! SingsNote');
$.lang.register('ytplayer.console.client.disconnected', 'SingsNote Song Request Player is disconnected! SingsNote');

$.lang.register('ytplayer.songrequests.enabled', 'SingsNote Song requests are enabled! SingsNote');
$.lang.register('ytplayer.songrequests.disabled', 'SingsNote Song requests have been disabled! SingsNote');

$.lang.register('ytplayer.command.volume.get', 'Current Song Player Volume: $1');
$.lang.register('ytplayer.command.volume.set', 'Set Song Player Volume: $1');

$.lang.register('ytplayer.command.ytp.resetdefaultlist.active', 'This must be ran when the Song Request Player is not connected.');
...
$.lang.register('ytplayer.command.songrequest.usage', 'Usage: !sr [YouTube ID | YouTube link | search string]');
