...
(function () {
    var anonNanme = $.getSetIniDbString('subscribeHandler', 'anonName', 'Anonymous viewer'),
        ...
        giftAnonSubMessage = $.getSetIniDbString('subscribeHandler', 'giftAnonSubMessage', '(name) gifted (recipient) a subscription!'),
        ...
        massAnonGiftSubMessage = $.getSetIniDbString('subscribeHandler', 'massAnonGiftSubMessage', '(name) gifted (amount) subscriptions to random viewers!'),
