...
(function() {
    ...
    $.bind('discordChannelCommand', function(event) {
        ...
        if (command.equalsIgnoreCase("editquote")) {
            if (args.length < 3) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.edit.usage'));
                return;
            }
            ...
            if (quote.length > 0) {
                if (args[1].equalsIgnoreCase("user")) {
                    $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.edit.user.success', args[0], args[2]));
                    quote[0] = args[2];
                    updateQuote(args[0], quote);
                } else if (args[1].equalsIgnoreCase("game")) {
                    $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.edit.game.success', args[0], args.splice(2).join(' ')));
                    quote[3] = args.splice(2).join(' ');
                    updateQuote(args[0], quote);
                } else if (args[1].equalsIgnoreCase("quote")) {
                    $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.edit.quote.success', args[0], args.splice(2).join(' ')));
                ...
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.edit.404'));
            }
        ...
        if (command.equalsIgnoreCase('quotemodetoggle')) {
            if (quoteMode) {
                ...
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.add.usage2'));
                return;
            } else {
                quoteMode = true;
                $.inidb.set('settings', 'quoteMode', 'true');
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.add.usage1'));
                return;
            }
        }
        ...
        if (command.equalsIgnoreCase('addquote')) {
            if (quoteMode) {
                ...
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.add.success', $.username.resolve(sender), saveQuote(String($.username.resolve(sender)), quote)));
                ...
                if (!$.user.isKnown(target)) {
                    $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('common.user.404', target));
                    return;
                }
                quote = args.splice(1).join(' ');
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.add.success', $.username.resolve(target), saveQuote(String($.username.resolve(target)), quote)));
                $.log.event(sender + ' added a quote "' + quote + '".');
                return;
            }
        }
        ...
        if (command.equalsIgnoreCase('delquote')) {
            if (!args[0] || isNaN(args[0])) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.del.usage'));
                return;
            }
            ...
            if ((newCount = deleteQuote(args[0])) >= 0) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.del.success', args[0], newCount));
            } else {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.del.404', args[0]));
            }
        ...
        if (command.equalsIgnoreCase('quote')) {
            ...
            if (quote.length > 0) {
                ...
                $.discord.say(channel, $.discord.userPrefix(mention) + quoteStr);
            } else {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.get.404', (typeof args[0] != 'undefined' ? args[0] : '')));
            }
        }
        ...
        if (command.equalsIgnoreCase('quotemessage')) {
            if (!args[0]) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.quotemessage.usage'));
                return;
            }

            quoteStr = args.splice(0).join(' ');
            $.inidb.set('settings', 'quoteMessage', quoteStr);
            $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.quotemessage.success'));
        ...
        if (command.equalsIgnoreCase('searchquote')) {
            if (!args[0]) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.searchquote.usage'));
                return;
            }
            ...
            if (matchingKeys.length == 0) {
                $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.searchquote.404'));
                return;
            }

            $.discord.say(channel, $.discord.userPrefix(mention) + $.lang.get('quotesystem.searchquote.found', matchingKeys.join(', ')));
        }
    });
    ...
    $.bind('initReady', function() {
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'quotemodetoggle', 2);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'searchquote', 7);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'addquote', 2);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'addquotesilent', 1);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'delquote', 2);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'delquotesilent', 1);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'editquote', 2);
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'quote');
        $.discord.registerCommand('./discord/systems/quoteSystem.js', 'quotemessage', 1);
    });
})();
