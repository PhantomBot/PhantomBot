...
(function() {
     ...
     $.bind('command', function(event) {
        ...
        if (command.equalsIgnoreCase('resetsongs')) {
            // Reset total song counter
            $.inidb.set("songcounts", "totalsongs", 0);
        
            // Remove user request played counter
	...
	// $.registerChatCommand('script', 'command', 'permission');
       ...
       $.registerChatCommand('./systems/custom/kentobotSystem.js', 'resetsongs', 2) ;
    });
 })();
