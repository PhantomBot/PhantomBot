(function() {
    ...
    $.bind('command', function(event) {
        ...
        /**
         * @commandpath auction [open | close | warn] - Primary auction command
         */
        if (command.equalsIgnoreCase('auction')) {
            ...
            /**
             * @commandpath auction warn - Shows the top bidder
             */
        ...
        /**
         * @commandpath bid (amount) - bids the amount you want on an auction
         */
