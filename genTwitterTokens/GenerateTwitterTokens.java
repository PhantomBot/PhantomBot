        ...
        try {
            ...
            while (accessToken == null) {
                System.out.println("PhantomBot Twitter API Connection Tool\r\n\r\n" + 
                                   "This tool will request access to read and write access to your Twitter account.\r\n" +
                                   "You will be presented with a URL to open in your local browser to approve\r\n" +
                                   "access. This application will attempt to launch a browser for you automatically.\r\n" +
                                   "You will be presented with a PIN that you must provide back to this application.\r\n" +
                                   "After that is completed, Twitter will generate OAuth keys which will be stored in\r\n" +
                                   "the PhantomBot directory as twitter.txt. Do keep this file safe! You may regenerate\r\n" +
                                   "the OAuth keys at any time.\r\n\r\n");
                 
                System.out.println("Open the following URL in your browser if a browser does not automatically launch\r\n" +
                ...
                while (username.length() < 1) {
                    System.out.print("Please provide your Twitter username for PhantomBot to generate Twitter URLs: ");
                    try {
            ...
            try {
                twitterData = "# Twitter Configuration File\r\n" +
                              ...
                              "# Do NOT Modify! If new tokens are required, run the application again.\r\n" +
                ...
                System.out.println("Unable to create twitter.txt.  Please create with the following content:\r\n" + twitterData);
                System.exit(1);
            }
        } catch (TwitterException ex) {
            System.out.println("Twitter returned an error:\r\n" + ex.getMessage());
