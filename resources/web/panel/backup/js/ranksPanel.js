...
(function() {
    ...
    function onMessage(message) {
        ...
        if (msgObject['dbqueryresult'] !== undefined) {
            ...
            if (msgObject['dbqueryresult'].localeCompare('ranks_time') === 0) {
                customHours = msgObject['result']['rankEligableTime'];
                $("#customRankTimeInput").attr("placeholder", customHours);
                $("#customRankTimeInput").val('');
            }
            if (msgObject['dbqueryresult'].localeCompare('ranks_cost') === 0) {
                customCost = msgObject['result']['rankEligableCost'];
        ...
        if (msgObject['dbkeysresult'] !== undefined) {
            ...
            if (msgObject['dbkeysresult'].localeCompare('ranks_ranksmapping') === 0) {
            ...
            if (msgObject['dbkeysresult'].localeCompare('ranks_customranks') === 0) {
                html = "<br><table><tr><th /><th>Hours in Chat</th><th>Rank Name</th></tr>";
                ranksData = msgObject['results'];
                ranksData.sort();
                for (idx = 0; idx < ranksData.length; idx++) {
